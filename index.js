...
// Define the variable record which stores an array of a superbowl win in 2015.
const record = [
...
// Declare the function superbowlWin(record)
function superbowlWin(record){
  // Return undefined if our record has no win objects
  // Return the year Denver Broncos won the superbowl
